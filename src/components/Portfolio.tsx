...
const fallbackProjects: Project[] = [
  ...
  { id: "3", title: "Galería Casa", location: "Pilar, Buenos Aires", category: "Real Estate", panoramaUrl: "/360_galeria_lomada.jpeg", thumbnailUrl: "/360LOW_galeria_lomada-Small.jpeg", description: "Espacio exterior integrado con parrilla y vista al parque." },
  ...
  { id: "11", title: "Baño Recoleta", location: "Recoleta, Buenos Aires", category: "Real Estate", panoramaUrl: "/Bano-Recoleta.jpg", thumbnailUrl: "/360LOW_Bano-Recoleta-Small.jpeg", description: "Visualización de remodelación premium en zona céntrica." },
  { id: "12", title: "Habitación Tunqueley", location: "San Martín de los Andes, Neuquén", category: "Hotel", panoramaUrl: "/Habitacion-Tunqueley.jpg", thumbnailUrl: "/360LOW_Habitacion-Tunqueley-Small.jpeg", description: "Captura inmersiva de suite principal con detalles patagónicos." },
